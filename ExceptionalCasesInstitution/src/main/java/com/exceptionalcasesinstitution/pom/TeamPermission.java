...
public class TeamPermission 
{
	...
	WebDriverWait wait;
	public TeamPermission(WebDriver driver)
	{
		this.driver=driver;
	...
	@FindBy(xpath ="//a[@data-toggle='collapse']//span[text()='Team']")
	WebElement team;
	...
	public void PermissionFields()
	{
		...
		try 
		{
			...
			//nexttab.click();
			Thread.sleep(3000);
			searchtab.sendKeys("Institution/Team");
			Thread.sleep(3000);
			natab.click();
			Thread.sleep(3000);
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Team Permission For NA :-");
			System.out.println("Institution User Tab");
			 ...
			 Thread.sleep(3000);
			 UtilityFile.screenShot(driver);
			 exi.executeScript("arguments[0].scrollIntoView();", team);
			 Thread.sleep(3000);
			 Assert.assertEquals(true, team.isDisplayed());
			 System.out.println("Team Tab Is Visible");
			 System.out.println("  ");
			 Thread.sleep(2000);
	...
	{driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		try 
		{
			Thread.sleep(2000);
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(false, team.isDisplayed());
	...
	public void ROPermissionFields()
	{
		...
		try 
		{
			...
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Team Permission For RO :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
	...
	public void RWPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Team Permission For RW :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
	...
	public void FCPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Team Permission For FC :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
