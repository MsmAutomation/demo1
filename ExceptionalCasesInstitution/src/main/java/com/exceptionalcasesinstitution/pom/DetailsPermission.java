...
public class DetailsPermission 
{
	WebDriver driver;
	Actions a;
	JavascriptExecutor exi;
	WebDriverWait wait;
	public DetailsPermission(WebDriver driver)
	{
		this.driver=driver;
	...
	public void PermissionFields()
	{
		...
		try 
		{
			...
			//nexttab.click();
			Thread.sleep(3000);
			searchtab.sendKeys("Institution/Detail");
			Thread.sleep(3000);
			natab.click();
			Thread.sleep(3000);
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Details Permission For NA :-");
			System.out.println("Institution User Tab");
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(true, detail.isDisplayed());
			 System.out.println("Details Tab Is Visible");
			 System.out.println("  ");
			 Thread.sleep(2000);
	...
	{driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		try 
		{
			Thread.sleep(2000);
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(false, instutation.isDisplayed());
			 instutation.click(); 
			 Thread.sleep(3000);
			 Assert.assertEquals(true, detail.isDisplayed());
		...
		catch (Exception e) 
		{
			...
			System.out.println("Institution and Details Not Present");
			System.out.println("  ");
			UtilityFile.Tab0(driver);
		}
	...
	public void ROPermissionFields()
	{
		...
		try 
		{
			...
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Details Permission For RO :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			 ...
			 Thread.sleep(2000);
			 exi.executeScript("arguments[0].scrollIntoView();", detail);
			 Assert.assertEquals(true, detail.isDisplayed());
			 System.out.println("Details Tab Is Visible");
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 rodtupds=driver.findElements(By.xpath("//button[@type='submit']"));
			...
			Thread.sleep(3000);
			 ...
			 System.out.println(" ");
				HashSet<String> hsro = new HashSet<String>(rosubinst);
				 ...
				 UtilityFile.screenShot(driver);
				 Thread.sleep(3000);
				 rosubdtupds=driver.findElements(By.xpath("//button[@type='submit']"));
	...
	public void RWPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Details Permission For RW :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			...
			// a.moveToElement(detail).click(detail).build().perform();
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 rwdtupds=driver.findElements(By.xpath("//button[@type='submit']"));
	...
	public void SubRWPermissionFields()
	{
		try 
		{
			...
			Thread.sleep(3000);
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			rwsubdtupds=driver.findElements(By.xpath("//button[@type='submit']"));
	...
	public void FCPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Details Permission For FC :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			...
			// a.moveToElement(detail).click(detail).build().perform();
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 fcdtupds=driver.findElements(By.xpath("//button[@type='submit']"));
	...
	public void SubFCPermissionFields()
	{
		try 
		{
			...
			Thread.sleep(3000);
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			fcsubdtupds=driver.findElements(By.xpath("//button[@type='submit']"));
