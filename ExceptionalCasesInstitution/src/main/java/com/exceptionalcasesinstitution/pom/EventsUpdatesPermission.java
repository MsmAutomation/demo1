...
public class EventsUpdatesPermission 
{
	WebDriver driver;
	Actions a;
	JavascriptExecutor exi;
	WebDriverWait wait;
	public EventsUpdatesPermission(WebDriver driver)
	{
		this.driver=driver;
	...
	@FindBy(xpath ="//a[@data-toggle='collapse']//span[text()='Events/Updates']")
	WebElement eventsupdates;
	...
	public void PermissionFields()
	{
		...
		try 
		{
			...
			//nexttab.click();
			Thread.sleep(3000);
			searchtab.sendKeys("Institution/Events");
			Thread.sleep(3000);
			natab.click();
			Thread.sleep(3000);
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Events/Updates Permission For NA :-");
			System.out.println("Institution User Tab");
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(true, eventsupdates.isDisplayed());
			 System.out.println("Events/Updates Tab Is Visible");
			 System.out.println("  ");
			 Thread.sleep(2000);
	...
	{driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		try 
		{
			Thread.sleep(2000);
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(false, eventsupdates.isDisplayed());
		...
		catch (Exception e) 
		{
			...
			System.out.println("Events/Updates Not Present");
			System.out.println("  ");
			UtilityFile.Tab0(driver);
		}
	...
	public void ROPermissionFields()
	{
		...
		try 
		{
			...
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Events/Updates Permission For RO :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			 ...
			 Thread.sleep(2000);
			 exi.executeScript("arguments[0].scrollIntoView();", eventsupdates);
			 Assert.assertEquals(true, eventsupdates.isDisplayed());
			 System.out.println("Events/Updates Tab Is Visible");
			 Thread.sleep(2000);
			 ...
			 Thread.sleep(3000);
			 dcactions=driver.findElements(By.xpath("//div[@class='dx-scrollable-container']//button[@type='button']"));
				...
				HashSet<String> hsro = new HashSet<String>(rosubinst);
				 ...
				 System.out.println(" ");
					HashSet<String> hro = new HashSet<String>(rosubupdt);
					 ...
					 Thread.sleep(2000);
					 System.out.println(" ");
					 subdocactions=driver.findElements(By.xpath("//div[@class='dx-scrollable-container']//button[@type='button']"));
	...
	public void RWPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Events/Updates Permission For RW :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			 ...
			 rwdcactions=driver.findElements(By.xpath("//div[@class='dx-scrollable-container']//button[@type='button']"));
			...
			rwsubdtupds=driver.findElements(By.xpath("//div[@class='dx-datagrid-header-panel']//span[@class='mat-button-wrapper']//mat-icon"));
			 ...
			 System.out.println(" ");
				HashSet<String> hsrw = new HashSet<String>(rwsubupdt);
				 ...
				 System.out.println(" ");
				 rwsubdocactions=driver.findElements(By.xpath("//div[@class='dx-scrollable-container']//button[@type='button']"));
	...
	public void FCPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Events/Updates Permission For FC :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			...
			// a.moveToElement(detail).click(detail).build().perform();
			 ...
			 System.out.println(" ");
			 fcdcactions=driver.findElements(By.xpath("//div[@class='dx-scrollable-container']//button[@type='button']"));
			...
			fcsubdtupds=driver.findElements(By.xpath("//div[@class='dx-datagrid-header-panel']//span[@class='mat-button-wrapper']//mat-icon"));
			 ...
			 System.out.println(" ");
				HashSet<String> hsfc = new HashSet<String>(fcsubupdt);
				 ...
				 System.out.println(" ");
				 fcsubdocactions=driver.findElements(By.xpath("//div[@class='dx-scrollable-container']//button[@type='button']"));
