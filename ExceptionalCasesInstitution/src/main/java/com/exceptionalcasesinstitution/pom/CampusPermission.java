...
public class CampusPermission 
{
	WebDriver driver;
	Actions a;
	JavascriptExecutor exi;
	WebDriverWait wait;
	public CampusPermission(WebDriver driver)
	{
		this.driver=driver;
	...
	@FindBy(xpath ="//a[@data-toggle='collapse']//span[text()='Campus']")
	WebElement campus;
	...
	public void PermissionFields()
	{
		...
		try 
		{
			...
			//nexttab.click();
			Thread.sleep(3000);
			searchtab.sendKeys("Institution/Campus");
			Thread.sleep(3000);
			natab.click();
			Thread.sleep(3000);
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Campus Permission For NA :-");
			System.out.println("Institution User Tab");
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(true, campus.isDisplayed());
			 System.out.println("Campus Tab Is Visible");
			 System.out.println("  ");
			 Thread.sleep(2000);
	...
	{driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
		try 
		{
			Thread.sleep(2000);
			 ...
			 UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			 Assert.assertEquals(false, campus.isDisplayed());
		...
		catch (Exception e) 
		{
			...
			System.out.println("Campus Not Present");
			System.out.println("  ");
			UtilityFile.Tab0(driver);
		}
	...
	public void ROPermissionFields()
	{
		...
		try 
		{
			...
			UtilityFile.screenShot(driver);
			 Thread.sleep(3000);
			update.click();
			System.out.println("Campus Permission For RO :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
			 ...
			 Thread.sleep(2000);
			 exi.executeScript("arguments[0].scrollIntoView();", campus);
			 Assert.assertEquals(true, campus.isDisplayed());
			 System.out.println("Campus Tab Is Visible");
			 Thread.sleep(2000);
	...
	public void RWPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Campus Permission For RW :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("instutation Tab Is Visible");
			 instutation.click();
	...
	public void FCPermissionFields()
	{
		...
		try 
		{
			...
			update.click();
			Thread.sleep(2000);
			System.out.println("Campus Permission For FC :-");
			System.out.println("Institution User Tab");
			 Assert.assertEquals(true, instutation.isDisplayed());
			 System.out.println("Instutation Tab Is Visible");
			 instutation.click();
