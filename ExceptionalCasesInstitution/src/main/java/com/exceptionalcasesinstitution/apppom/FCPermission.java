...
public class FCPermission 
{
		...
		public void FCSubPermissionFields()
		{
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			a=new Actions(driver);
			wait = new WebDriverWait(driver, 40);
		...
		public void FCRecruiterAgentFields()
		{
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			a=new Actions(driver);
			wait = new WebDriverWait(driver, 40);
		...
		public void FCStudyPermitFields()
		{
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			a=new Actions(driver);
			wait = new WebDriverWait(driver, 40);
		...
		public void FCSubStudyPermitFields()
		{
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			a=new Actions(driver);
			wait = new WebDriverWait(driver, 40);
		...
		public void FCInstitutionDocFields()
		{
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			a=new Actions(driver);
			wait = new WebDriverWait(driver, 40);
		...
		public void FCSubInstitutionDocFields()
		{
			driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
			a=new Actions(driver);
			wait = new WebDriverWait(driver, 40);
			...
			try {
				...
				Thread.sleep(3000);
				  ...
				  subactiadds=driver.findElements(By.xpath("(//div[@class='dx-datagrid-header-panel'])[4]//span[@class='mat-button-wrapper']//mat-icon"));
					 ...
					 {
						 exi.executeScript("arguments[0].scrollIntoView();", subactiadd);
						 Thread.sleep(3000);
